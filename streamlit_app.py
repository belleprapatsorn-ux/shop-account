...
with tab2:
    ...
    expense_structure = {
        "🥬 จ่ายตลาดสด (ของสดรายวัน)": ["ร้านไก่สด", "ร้านตีนไก่", "เลือดไก่", "ร้านเส้นก๋วยเตี๋ยว", "ผักสด", "อื่น ๆ"],
        "📦 สั่งของเข้าร้าน (Online/ห้าง)": ["แมคโคร (Makro)", "Shopee (ซื้อของ)", "Lazada (ซื้อของ)", "Grab Mart", "LineMan Mart", "เครื่องปรุงซอง"],
